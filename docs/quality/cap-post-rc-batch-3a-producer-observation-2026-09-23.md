...
| This report's own commit | docs-only, on top of `7d3d6a5`; §K classifies it INHERITED, and it changes no measurement -- every field below comes from `7d3d6a5`'s run |
